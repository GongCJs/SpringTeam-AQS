...
function(window, undefined) {
	...
	function _each(a, b) {
		...
		else for (var e in a) if (a.hasOwnProperty(e) && b.call(a[e], e, a[e]) === !1) break
	}
	function _trim(a) {
		return a.replace(/(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g, "")
	}
	...
	function _getBasePath() {
		for (var a, b = document.getElementsByTagName("script"), c = 0, d = b.length; d > c; c++) if (a = b[c].src || "", /kindeditor[\w\-\.]*\.js/.test(a)) return a.substring(0, a.lastIndexOf("/") + 1);
		return ""
	}
	...
	function _ready(a) {
		function b() {
			e || (e = !0, a(KindEditor), _readyFinished = !0)
		}
		function c() {
			if (!e) {
				try {
		...
		if (_readyFinished) return void a(KindEditor);
		var e = !1;
	...
	function _formatHtml(a, b, c, d, e) {
		...
		return a = a.replace(h,
			...
			if ("" !== s) {
				...
				_each(x,
						function(a, d) {
					if (_FILL_ATTR_MAP[a] && (x[a] = a), _inArray(a, ["src", "href"]) >= 0 && (x[a] = _formatUrl(d, c)), (b && "style" !== a && !g[r]["*"] && !g[r][a] || "body" === r && "contenteditable" === a || /^kindeditor_\d+$/.test(a)) && delete x[a], "style" === a && "" !== d) {
						var e = _getCssList(d);
						_each(e,
								function(a) { ! b || g[r].style || g[r]["." + a] || delete e[a]
						});
						var f = "";
						_each(e,
								function(a, b) {
	...
	function _removeTempTag(a) {
		return a.replace(/<div[^>]+class="?__kindeditor_paste__"?[^>]*>[\s\S]*?<\/div>/gi, "")
	}
	...
	function _create(a, b) {
		function c(a) {
			return _each(_plugins,
					function(b, c) {
				_isFunction(c) && (c.call(a, KindEditor), a._pluginStatus || (a._pluginStatus = {}), a._pluginStatus[b] = "inited")
			}),
			a.create()
		}
		if (b = b || {},
				b.basePath = _undef(b.basePath, K.basePath), b.themesPath = _undef(b.themesPath, b.basePath + "themes/"), b.langPath = _undef(b.langPath, b.basePath + "lang/"), b.pluginsPath = _undef(b.pluginsPath, b.basePath + "plugins/"), _undef(b.loadStyleMode, K.options.loadStyleMode)) {
	...
	if (!window.KindEditor) {
		...
		_extend(KRange, {
			...
			createBookmark: function(a) {
				...
				return e.id = "__kindeditor_bookmark_start_" + _BOOKMARK_ID+++"__",
				c.collapsed || (b = e.cloneNode(!0), b.id = "__kindeditor_bookmark_end_" + _BOOKMARK_ID+++"__"),
			...
			init: function(a) {
				...
				if (b.name = a.name || "", b.doc = a.doc || document, b.win = _getWin(b.doc), b.x = _addUnit(a.x), b.y = _addUnit(a.y), b.z = a.z, b.width = _addUnit(a.width), b.height = _addUnit(a.height), b.div = K('<div style="display:block;"></div>'), b.options = a, b._alignEl = a.alignEl, b.width && b.div.css("width", b.width), b.height && b.div.css("height", b.height), b.z && b.div.css({
					...
					K(b.win).bind("scroll",
						...
						d = a.x - c.x,
						e = a.y - c.y;
						b.pos(_removeUnit(b.x) + d, _removeUnit(b.y) + e, !1)
					})
		...
		KEditor.prototype = {
				...
				loadPlugin: function(a, b) {
					...
					_plugins[a] ? _isFunction(_plugins[a]) ? (d[a] || (_plugins[a].call(c, KindEditor), d[a] = "inited"), b && b.call(c), c) : (setTimeout(function() {
						c.loadPlugin(a, b)
					},
				...
				create: function() {
					...
					_docElement().style.overflow = c ? "hidden": "";
							...
							m = b.edit = _edit({
								height: l > 0 && _removeUnit(e) > b.minHeight ? l: b.minHeight,
										...
										afterCreate: function() {
											if (b.edit = m = this, b.cmd = m.cmd, b._docMousedownFn = function() {
												b.menu && b.hideMenu()
											},
											K(m.doc, document).mousedown(b._docMousedownFn), _bindContextmenuEvent.call(b), _bindNewlineEvent.call(b), _bindTabEvent.call(b), _bindFocusEvent.call(b), m.afterChange(function() {
				...
				remove: function() {
					var a = this;
					return a.isCreated ? (a.beforeRemove(), a.srcElement.data("kindeditor", ""), a.menu && a.hideMenu(), _each(a.dialogs,
							function() {
						a.hideDialog()
		...
		k = b.createDialog({
			...
			yesBtn: {
				...
				click: function() {
					...
					d = c.lng + "," + c.lat,
					g = a.getZoom(),
					i = [o[0].checked ? b.pluginsPath + "baidumap/index.html": "http://api.map.baidu.com/staticimage", "?center=" + encodeURIComponent(d), "&zoom=" + encodeURIComponent(g), "&width=" + e, "&height=" + f, "&markers=" + encodeURIComponent(d), "&markerStyles=" + encodeURIComponent("l,A")].join("");
					o[0].checked ? b.insertHtml('<iframe src="' + i + '" frameborder="0" style="width:' + (e + 2) + "px;height:" + (f + 2) + 'px;"></iframe>') : b.exec("insertimage", i),
							b.hideDialog().focus()
				}
			},
...
KindEditor.plugin("map",
	...
	b.clickToolbar(c,
		...
		var f, g, h = ['<div style="padding:10px 20px;">', '<div class="ke-dialog-row">', d.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:200px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' + d.search + '" />', "</span>", "</div>", '<div class="ke-map" style="width:558px;height:360px;"></div>', "</div>"].join(""),
		i = b.createDialog({
			name: c,
			width: 600,
			title: b.lang(c),
			...
			yesBtn: {
				name: b.lang("yes"),
				click: function() {
					var a = (f.geocoder, f.map),
					c = a.getCenter().lat() + "," + a.getCenter().lng(),
					d = a.getZoom(),
					e = a.getMapTypeId(),
					g = "http://maps.googleapis.com/maps/api/staticmap";
					g += "?center=" + encodeURIComponent(c),
					g += "&zoom=" + encodeURIComponent(d),
					g += "&size=558x360",
					g += "&maptype=" + encodeURIComponent(e),
					g += "&markers=" + encodeURIComponent(c),
					g += "&language=" + b.langType,
					g += "&sensor=false",
					b.exec("insertimage", g).hideDialog().focus()
				}
			},
			beforeRemove: function() {
				l.remove(),
	...
	b.clickToolbar(c,
		...
		f = b.createDialog({
			...
			yesBtn: {
				name: b.lang("yes"),
				click: function() {
					var c = a(".ke-code-type", f.div).val(),
					e = g.val(),
					h = "" === c ? "": " lang-" + c,
...
KindEditor.plugin("filemanager",
	...
	d.plugin.filemanagerDialog = function(b) {
		...
		function k(b, c) {
			...
			x.unbind(),
			y.unbind(),
			b.current_dir_path && w.click(function() {
		...
		function m(b) {
			...
			for (var d = b.file_list,
				...
				v.append(l);
				var n = a('<div class="ke-inline-block ke-photo"></div>').mouseover(function() {
					a(this).addClass("ke-on")
				}).mouseout(function() {
					a(this).removeClass("ke-on")
				});
				...
				l = b.createDialog({
					...
					yesBtn: {
						...
						click: function() {
							...
							d = p.val(),
							e = q.val();
							if ("http://" == c || a.invalidUrl(c)) return alert(b.lang("invalidUrl")),
							void n[0].focus();
							if (!/^\d*$/.test(d)) return alert(b.lang("invalidWidth")),
							void p[0].focus();
							if (!/^\d*$/.test(e)) return alert(b.lang("invalidHeight")),
							void q[0].focus();
							var f = a.mediaImg(b.themesPath + "common/blank.gif", {
								src: c,
							...
							b.insertHtml(f).hideDialog().focus()
						}
					}
				}),
				m = l.div,
...
KindEditor.plugin("image",
	...
	b.plugin.imageDialog = function(d) {
		...
		q = d.clickFn,
		r = "kindeditor_upload_iframe_" + (new Date).getTime(),
		s = [];
								...
								click: function() {
									if (!y.isLoading) {
										...
										return H.each(function() {
											return this.checked ? (g = this.value, !1) : void 0
										}),
										"http://" == c || a.invalidUrl(c) ? (alert(b.lang("invalidUrl")), void A[0].focus()) : /^\d*$/.test(d) ? /^\d*$/.test(e) ? void q.call(b, c, f, d, e, 0, g) : (alert(b.lang("invalidHeight")), void E[0].focus()) : (alert(b.lang("invalidWidth")), void D[0].focus())
									}
								}
							},
							beforeRemove: function() {
		...
		return F.click(function() {
			var b = a('<img src="' + A.val() + '" />', document).css({
				position: "absolute",
				visibility: "hidden",
				top: 0,
				left: "-1000px"
		...
		p = b.createDialog({
			...
			yesBtn: {
				...
				click: function() {
					var c = a.trim(r.val()),
					d = t.val();
					return "http://" == c || a.invalidUrl(c) ? (alert(b.lang("invalidUrl")), void r[0].focus()) : ("" === a.trim(d) && (d = c), void n.call(b, c, d))
				}
			}
		}),
		q = p.div,
			...
			edit: function() {
				...
				f = b.createDialog({
					...
					yesBtn: {
						...
						click: function() {
							var c = a.trim(h.val());
							return "http://" == c || a.invalidUrl(c) ? (alert(b.lang("invalidUrl")), void h[0].focus()) : void b.exec("createlink", c, i.val()).hideDialog().focus()
						}
					}
				}),
				g = f.div,
	...
	a.extend(b, {
		init: function(b) {
			...
			var e = {
					...
					file_queue_error_handler: function(c, d) {
						var e = "";
						switch (d) {
						case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED:
							e = b.queueLimitExceeded;
							break;
						case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
							e = b.fileExceedsSizeLimit;
							break;
					...
					upload_error_handler: function(b) {
						if (b && b.filestatus == SWFUpload.FILE_STATUS.ERROR) {
							var e = a('div[data-id="' + b.id + '"]', d.bodyDiv).eq(0);
							c(e, d.options.errorMessage)
						}
					},
		...
		appendFile: function(b) {
			...
			c.bodyDiv.append(d);
			var e = a('<div class="ke-inline-block ke-photo"></div>').mouseover(function() {
				a(this).addClass("ke-on")
			}).mouseout(function() {
				a(this).removeClass("ke-on")
			});
...
function() {
	...
	SWFUpload.prototype.getFlashHTML = function() {
		var a = "";
		return KindEditor.IE && KindEditor.V > 8 && (a = ' classid = "clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"'),
...
KindEditor.plugin("pagebreak",
	...
	b.clickToolbar(c,
		...
		e = c.range;
		b.focus();
		var f = "br" == b.newlineTag || a.WEBKIT ? "": '<span id="__kindeditor_tail_tag__"></span>';
		if (b.insertHtml(d + f), "" !== f) {
			var g = a("#__kindeditor_tail_tag__", b.edit.doc);
		...
		f = b.createDialog({
			...
			yesBtn: {
				...
				click: function() {
					...
					c = a.escape(c),
					c = c.replace(/ {2}/g, " &nbsp;"),
					c = "p" == b.newlineTag ? c.replace(/^/, "<p>").replace(/$/, "</p>").replace(/\n/g, "</p><p>") : c.replace(/\n/g, "<br />$&"),
							b.insertHtml(c).hideDialog().focus()
				}
			}
		}),
		g = a("textarea", f.div);
				...
				k = e.createDialog({
					...
					yesBtn: {
						...
						click: function() {
							...
							A = a(w[0]).html() || "",
							B = a(w[1]).html() || "";
							if (0 == b || !/^\d+$/.test(b)) return alert(e.lang("invalidRows")),
							void m[0].focus();
							if (0 == c || !/^\d+$/.test(c)) return alert(e.lang("invalidRows")),
							void n[0].focus();
							if (!/^\d*$/.test(d)) return alert(e.lang("invalidWidth")),
							void o[0].focus();
							if (!/^\d*$/.test(f)) return alert(e.lang("invalidHeight")),
							void p[0].focus();
							if (!/^\d*$/.test(k)) return alert(e.lang("invalidPadding")),
							void s[0].focus();
							if (!/^\d*$/.test(l)) return alert(e.lang("invalidSpacing")),
							void t[0].focus();
							if (!/^\d*$/.test(z)) return alert(e.lang("invalidBorder")),
							void v[0].focus();
							if (x) return "" !== d ? x.width(d + g) : x.css("width", ""),
									void 0 !== x[0].width && x.removeAttr("width"),
									"" !== f ? x.height(f + i) : x.css("height", ""),
											void 0 !== x[0].height && x.removeAttr("height"),
											x.css("background-color", B),
											void 0 !== x[0].bgColor && x.removeAttr("bgColor"),
											"" !== k ? x[0].cellPadding = k: x.removeAttr("cellPadding"),
													"" !== l ? x[0].cellSpacing = l: x.removeAttr("cellSpacing"),
															"" !== y ? x[0].align = y: x.removeAttr("align"),
																	"" !== z ? x.attr("border", z) : x.removeAttr("border"),
																			"" === z || "0" === z ? x.addClass(h) : x.removeClass(h),
																					"" !== A ? x.attr("borderColor", A) : x.removeAttr("borderColor"),
																							e.hideDialog().focus(),
																					...
																					for (var E = 0; b > E; E++) {
																						D += "<tr>";
																						for (var F = 0; c > F; F++) D += "<td>" + (a.IE ? "&nbsp;": "<br />") + "</td>";
																						D += "</tr>"
																					}
																					D += "</table>",
																					a.IE || (D += "<br />"),
				...
				i = e.createDialog({
					...
					yesBtn: {
						...
						click: function() {
							...
							u = a(t[0]).html() || "",
							w = a(t[1]).html() || "";
							return /^\d*$/.test(b) ? /^\d*$/.test(c) ? /^\d*$/.test(j) ? (v.css({
								width: "" !== b ? b + d: "",
										height: "" !== c ? c + f: "",
												"background-color": w,
												"text-align": g,
	...
	c.clickToolbar(d,
		...
		var g = c.createDialog({
			...
			yesBtn: {
				...
				click: function() {
					var b = a.iframeDoc(j);
					c[i[0].checked ? "html": "insertHtml"](b.body.innerHTML).hideDialog().focus()
				}
			}
		}),
		h = a("select", g.div),
	...
	b.clickToolbar(c,
		...
		f = b.createDialog({
			...
			yesBtn: {
				name: b.lang("yes"),
				click: function() {
					var c = i.body.innerHTML;
					c = a.clearMsWord(c, b.filterMode ? b.htmlTags: a.options.htmlTags),
					b.insertHtml(c).hideDialog().focus()
				}
			}
		}),
